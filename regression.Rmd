...
##### 2. Is the positive/negative sentiment stories associate with teenager pregnancy/suicide and political status of each states?
...
#### The Residual binned plots show no clear trends for the used model. The model is reasonable and the assumptions are met.
